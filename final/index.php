            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="mx-auto my-0 text-uppercase"><span style="font-family: segoe ui semibold;">Welcome!</span></h1>
...
<!--This is where I read a text file -->
                        ...
                        <h2 class="text-white-50 mx-auto mt-2 mb-5"><span style="text-shadow: -1px 1px 2px #99ccbb, 1px 1px 2px #99ccbb, 1px -1px 0 #99ccbb, -1px -1px 0 #99ccbb;"><?php
							$textfile = fopen("data\about.txt", "r");
							echo fread($textfile, filesize("data\about.txt"));
							fclose($textfile);
						?></span></h2>
