<!DOCTYPE html>
<?php
	require_once __DIR__ . "/../admin/comments/comments.php";
	$response = null;
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="mx-auto my-0 text-uppercase"><span style="font-family: segoe ui semibold;">User Wall:</span></h1>

<!--
I followed a tutorial on youtube as guidance for a lot of this section, but I also deviated from it so it a lot.
...
-->
						...
						<form action="" method="POST">
							...
							<textarea style="width: 750px; height: 250px;" name="comment"><?php echo @$_POST["comment"] ?></textarea><br><br>
